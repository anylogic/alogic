 ...
 * @since 1.6.10.3
 */
public class GetStatusCode extends ResponseHandler {

	protected String id = "$http-code";
	
	public GetStatusCode(String tag, Logiclet p) {
		super(tag, p);
	}
	...
	protected void onExecute(final Response res,
		...
		if (StringUtils.isNotEmpty(out)){
			ctx.SetValue(out, String.valueOf(res.getStatusCode()));
		}
	}
}