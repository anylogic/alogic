 ...
 * @since 1.6.10.3
 */
public class GetContentType extends ResponseHandler {

	protected String id = "$http-content-type";
	
	public GetContentType(String tag, Logiclet p) {
		super(tag, p);
	}
	...
	protected void onExecute(final Response res,
		...
		if (StringUtils.isNotEmpty(out)){
			ctx.SetValue(out, String.valueOf(res.getContentType()));
		}
	}
}