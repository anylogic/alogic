...
查询当前系统中所有配置服务目录和服务信息，以服务目录的形式返回。
...
| 编号 | 代码 | 类型 | 名称 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| 1 | catalog | Object[] | 服务目录列表  | 服务目录对象JSON描述见样例 |
...
服务地址如下；
```
	http://localhost:9000/services/core/ServiceQuery
```
输出结果：
```
	{
	                        ...
	                        }, 
	                        {
	                            "catalog": [
	                                ...
	                                }, 
	                                {
	                                    ...
	                                    "path": "/component/scheduler/timer"
	                                }
	                            ], 
	                            "name": "scheduler", 
	                            "service": [
