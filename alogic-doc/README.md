...
### 版本
 ...
 - 1.6.8 [20170320 duanyy]
 	 + 创建1.6.8-SNAPSHOT版本，开始1.6.8版本开发
 	 + 参见[1.6.8更新记录](alogic-1.6.8.md)
 	 
 - 1.6.9 [20170512 duanyy]
 	 + 创建1.6.9-SNAPSHOT版本，开始1.6.9版本开发
 	 + 参见[1.6.9更新记录](alogic-1.6.9.md)
 	 
 - 1.6.10 [20170512 duanyy]
 	 + 创建1.6.10-SNAPSHOT版本，开始1.6.10版本开发
 	 + 参见[1.6.10更新记录](alogic-1.6.10.md)	 
 	 
 - 1.6.11 [20171214 duanyy]
 	 + 创建1.6.11-SNAPSHOT版本，开始1.6.11版本开发
 	 + 参见[1.6.11更新记录](alogic-1.6.11.md)